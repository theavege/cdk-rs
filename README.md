...
- [x] [AlphaList](https://invisible-island.net/cdk/manpage/cdk_alphalist.3.html)
...
- [x] [Calendar](https://invisible-island.net/cdk/manpage/cdk_calendar.3.html)
- [x] [Dialog](https://invisible-island.net/cdk/manpage/cdk_dialog.3.html)
- [x] [Entry](https://invisible-island.net/cdk/manpage/cdk_entry.3.html) — entry field
- [x] [FSelect](https://invisible-island.net/cdk/manpage/cdk_fselect.3.html) — file selector
- [x] [FViewer](https://invisible-island.net/cdk/manpage/cdk_viewer.3.html) — file viewer
- [x] [Graph](https://invisible-island.net/cdk/manpage/cdk_graph.3.html)
- [x] [Histogram](https://invisible-island.net/cdk/manpage/cdk_histogram.3.html)
- [x] [Scale](https://invisible-island.net/cdk/manpage/cdk_scale.3.html) — integer scale
    - [x] [DScale](https://invisible-island.net/cdk/manpage/cdk_dscale.3.html) — double scale
    - [x] [FScale](https://invisible-island.net/cdk/manpage/cdk_fscale.3.html) — floating scale
    - [x] [UScale](https://invisible-island.net/cdk/manpage/cdk_uscale.3.html) — unsigned scale
- [x] [Slider](https://invisible-island.net/cdk/manpage/cdk_slider.3.html) — integer slider
    - [x] [FSlider](https://invisible-island.net/cdk/manpage/cdk_fslider.3.html) — floating slider
    - [x] [USlider](https://invisible-island.net/cdk/manpage/cdk_uslider.3.html) — unsigned slider
- [x] [ItemList](https://invisible-island.net/cdk/manpage/cdk_itemlist.3.html)
- [x] [Label](https://invisible-island.net/cdk/manpage/cdk_label.3.html)
- [x] [Marquee](https://invisible-island.net/cdk/manpage/cdk_marquee.3.html)
- [x] [Matrix](https://invisible-island.net/cdk/manpage/cdk_matrix.3.html)
- [x] [Mentry](https://invisible-island.net/cdk/manpage/cdk_mentry.3.html) — multiple line entry field
- [x] [Menu](https://invisible-island.net/cdk/manpage/cdk_menu.3.html) — pulldown menu
- [x] [Radio](https://invisible-island.net/cdk/manpage/cdk_radio.3.html) — radio list
- [x] [Scroll](https://invisible-island.net/cdk/manpage/cdk_scroll.3.html) — scrolling list
- [x] [Selection](https://invisible-island.net/cdk/manpage/cdk_selection.3.html) — scrolling selection list
- [x] [SWindow](https://invisible-island.net/cdk/manpage/cdk_swindow.3.html) — scrolling window
- [x] [Template](https://invisible-island.net/cdk/manpage/cdk_template.3.html) — template entry field
